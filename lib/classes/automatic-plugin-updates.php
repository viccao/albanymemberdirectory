...
if ( (!get_option('automatic_plugin_updates_send_emails')) || ( get_option('automatic_plugin_updates_send_emails') && (get_option('automatic_plugin_updates_send_emails')=='disabled') ) )
